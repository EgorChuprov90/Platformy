...
<section className="expa">
            <div className="expa__about">
                <div className="container">
                    ...
                    <p className="expa__about_text"> ООО "Морские платформы" обладает богатым опытом работы в самых сложный условиях, включая крайний север России. </p>
                    <p className="expa__about_text">Наш профессионализм и надежность позволяют нам осуществлять проекты
