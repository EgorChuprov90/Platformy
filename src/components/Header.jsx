...
function Header() {
  ...
  return (
    ...
    <nav className={isOn ? "menu__list_mobile" : "menu__list_mobile menu__list_hidden"}>
            <NavLink to='/' className='menu__link_mobile '>О компании</NavLink>
            <NavLink to='/services' className='menu__link_mobile '>Услуги</NavLink>
            <NavLink to='/technic' className='menu__link_mobile '>Техника</NavLink>
            <NavLink to='/experience' className='menu__link_mobile '>Опыт и география</NavLink>
            <NavLink to='/contacts' className='menu__link_mobile '>Контакты</NavLink>
        </nav>  
      </div>
